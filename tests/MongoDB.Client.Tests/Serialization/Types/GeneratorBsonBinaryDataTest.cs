...
namespace MongoDB.Client.Tests.Serialization.Types
{
    ...
    //public partial class GeneratorBsonBinaryDataModel : GeneratorTypeTestModelBase<BsonBinaryData, BsonBinaryData?>, IEquatable<GeneratorBsonBinaryDataModel>
    //{
    //    public GeneratorBsonBinaryDataModel(
    ...
    //    }
    //    public static GeneratorBsonBinaryDataModel Create()
    //    {
    ...
    //        return new GeneratorBsonBinaryDataModel(
    //            value, value, null, 
    ...
    //    public bool Equals(GeneratorBsonBinaryDataModel other)
    //    {
    //        return other != null &&
    ...
    //    {
    //        var model = GeneratorBsonBinaryDataModel.Create();
    //        var result = await RoundTripAsync(model);
    //        var bson = await RoundTripWithBsonAsync(GeneratorBsonBinaryDataModel.Create());

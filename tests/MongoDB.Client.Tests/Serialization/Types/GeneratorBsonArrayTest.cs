...
namespace MongoDB.Client.Tests.Serialization.Types
{
    ...
    //public partial class GeneratorBsonArrayModel : GeneratorTypeTestModelBase<BsonArray, BsonArray?>, IEquatable<GeneratorBsonArrayModel>
    //{
    //    public GeneratorBsonArrayModel(
    //        BsonArray property, 
    ...
    //    }
    //    public static GeneratorBsonArrayModel Create()
    //    {
    //        var value = new BsonArray();
    //        value.Add("123");
    //        value.Add("3211");
    //        return new GeneratorBsonArrayModel(
    //            value, value, null, 
    ...
    //    public bool Equals(GeneratorBsonArrayModel other)
    //    {
    //        return other != null &&
    ...
    //    {
    //        var model = GeneratorBsonArrayModel.Create();
    //        var result = await RoundTripAsync(model);
    //        var bson = await RoundTripWithBsonAsync(GeneratorBsonArrayModel.Create());

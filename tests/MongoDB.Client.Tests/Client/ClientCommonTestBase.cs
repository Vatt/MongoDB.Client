...
namespace MongoDB.Client.Tests.Client
{
    public class ClientCommonTestBase : ClientTestBase
    {
        protected async Task InsertTest(MongoClient client)
        {
            ...
            var collection = db.GetCollection<CommonModel>("InsertTestCollection" + Guid.NewGuid());
        ...
        protected async Task UpdateOneTest(MongoClient client)
        {
            ...
            var db = client.GetDatabase(DB);
            var collection = db.GetCollection<CommonModel>("UpdateOneCollection" + Guid.NewGuid());
        ...
        protected async Task UpdateManyTest(MongoClient client)
        {
            ...
            var update = Update.Set(updateDoc);
            var db = client.GetDatabase(DB);
            var collection = db.GetCollection<CommonModel>("UpdateManyCollection" + Guid.NewGuid());
        ...
        protected async Task DeleteOneTest(MongoClient client)
        {
            ...
            var db = client.GetDatabase(DB);
            var collection = db.GetCollection<CommonModel>("DeleteOneCollection" + Guid.NewGuid());
        ...
        protected async Task DeleteManyTest(MongoClient client)
        {
            ...
            var delete = BsonDocument.Empty;
            var db = client.GetDatabase(DB);
            var collection = db.GetCollection<CommonModel>("DeleteManyCollection" + Guid.NewGuid());

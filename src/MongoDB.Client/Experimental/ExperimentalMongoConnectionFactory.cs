...
namespace MongoDB.Client.Experimental
{
    internal class ExperimentalMongoConnectionFactory : IMongoConnectionFactory
    {
        ...
        public async ValueTask<MongoConnection> CreateAsync(MongoClientSettings settings)
        {
            ...
            var connection = new MongoConnection(id, settings, _loggerFactory.CreateLogger<MongoConnection>());

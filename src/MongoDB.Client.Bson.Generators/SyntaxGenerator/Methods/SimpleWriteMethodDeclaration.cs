...
namespace MongoDB.Client.Bson.Generators.SyntaxGenerator.Methods
{
    internal class SimpleWriteMethodDeclaration : WriteMethodDeclarationBase
    {
        ...
        public static ExpressionSyntax reservedSizeExpr = SG.NumericLiteralExpr(4);
        ...
        protected virtual StatementSyntax GenerateWriteEndMarker()
        {
            ...
            return SF.ExpressionStatement(
                    SF.InvocationExpression(SG.SimpleMemberAccess(Basics.WriterInputVariableIdentifierName, writeByteMethodId),
            ...
            var equalsValueClause = SF.EqualsValueClause(
                                        SF.StackAllocArrayCreationExpression(
                                            SF.ArrayType(
                                                ...
                                                SF.SingletonList(SF.ArrayRankSpecifier().AddSizes(SG.NumericLiteralExpr(4))))));
        ...
        {
            return SF.ExpressionStatement(SG.InvocationExpr(reservedId, SF.IdentifierName("Write"), SF.Argument(sizeSpanNameId)));
        }
